            ...
            <div class="card-body">
              ...
              <form class="row g-3"  method="POST" action="{{ route('item.store') }}">
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" id="txtItemBrand" name="txtItemBrand" value="{{ Session::get('txtItemBrand') }}">
                </div>

                <div class="col-12">
                  <label for="txtItemType" class="form-label">Item Type</label>
                  <input type="text" class="form-control" id="txtItemType" name="txtItemType" value="{{ Session::get('txtItemType') }}">
                </div>
                <div class="col-12">
                  <label for="txtItemPrice" class="form-label">Item Price</label>
                  <input type="text" class="form-control" id="txtItemPrice" name="txtItemPrice" value="{{ Session::get('txtItemPrice') }}">
                </div>
                      ...
                      <div class="col-sm-10">
                          <select class="form-select" aria-label="Default select example" id="selInstitution" name="selInstitution">
                              ...
                              @foreach($data['institutions'] as $institution)
                                  <option value="{{ $institution->institution_id }}">{{ $institution->institution_code .'-'. $institution->institution_name }}</option>
                              @endforeach
                          </select>
                      </div>
                  </div>
              ...
              <div class="col-12">
                  <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                          <select class="form-select" aria-label="Default select example" id="selRoom" name="selRoom" disabled>
                ...
                <div class="center">
                  ...
                  <p>
                        ...
                        <span class="input-group-btn">
                            <button type="button" class="btn btn-danger btn-number"  data-type="minus" data-field="txtItemQty">
                              <span class="glyphicon glyphicon-minus"><i class="bi bi-dash"></i></span>
                            </button>
                        </span>
                        <input style="text-align: center" type="text" name="txtItemQty" class="form-control input-number" value="{{ Session()->has('txtItemQty') ? Session::get('txtItemQty') : 1 }}"
                        min="1" max="100">
                        <span class="input-group-btn">
                            <button type="button" class="btn btn-success btn-number" data-type="plus" data-field="txtItemQty">
  ...
  <script>
    $(document).ready(function() {
        ...
        function populateRooms(institutionId) {
            $.ajax({
                url: '/api/rooms/' + institutionId, // Ganti URL dengan endpoint yang sesuai untuk mendapatkan data Room berdasarkan Institution
                type: 'GET',
                dataType: 'json',

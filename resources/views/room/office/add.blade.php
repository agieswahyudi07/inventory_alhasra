    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form class="row g-3"  method="POST" action="{{ route('office.store') }}">
                @csrf
                <div class="col-12">
                  <label for="txtOfficeName" class="form-label">{{ $data['title'] }} Name</label>
                  <input type="text" class="form-control" id="txtOfficeName" name="txtOfficeName" value="{{ Session::get('txtOfficeName') }}">
                </div>
